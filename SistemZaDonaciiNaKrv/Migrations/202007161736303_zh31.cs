namespace SistemZaDonaciiNaKrv.Migrations
{
    ...
    public partial class zh31 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        daliOdobreno = c.Boolean(nullable: false),
                        Name = c.String(),
                        LastName = c.String(),
                        Address = c.String(),
                        Phone = c.String(),
                        ...
                        daliZolticaMalarija = c.Boolean(nullable: false),
                        daliSrceviPritisok = c.Boolean(nullable: false),
                        daliAlergjaAstma = c.Boolean(nullable: false),
                        daliGrcevi = c.Boolean(nullable: false),
                        daliHronicni = c.Boolean(nullable: false),
                        daliToksoPlazmoza = c.Boolean(nullable: false),
                        daliBruceloza = c.Boolean(nullable: false),
